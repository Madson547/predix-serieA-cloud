...
def salvar_estatisticas_partida(
    ...
    time. É essa tabela que permite o Medidor de Desempenho comparar
    "quanto o modelo previu pra esse jogo" com "quanto realmente saiu
    nesse jogo", em vez de só saber a média histórica do time.
    """
    if not fixture_id:
        return
    try:
        supabase.table("estatisticas_partidas").upsert({
